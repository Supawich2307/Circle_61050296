 ...
 * USAGE:
 * <pre>
 *        ClientCircle client = new ClientCircle();
...
public class ClientCircle {
    ...
    private static final String BASE_URI = "http://localhost:8080/WebCircle/webresources";
    ...
    public String Area(String radius) throws ClientErrorException {
